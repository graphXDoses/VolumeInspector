...
#include "../src/Engine/Platform/PlatformUtils.h"

#include <imgui.h>

#include <glad/glad.h>

//#include "../src/Engine/Graphics/Primitives/QuadMesh.h"
#include "../src/Engine/Graphics/Primitives/CubeMesh.h"
#include "../src/Engine/ImGui/Prototypes/CustomWidgets.h"
...
namespace VolumeEngine
{
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		if (m_showLegend)
			ImGui::VolumeEngineUI::IntensityLegend("##IntensityLegend", &m_colorizeIntensity);
		...
		ImGui::VolumeEngineUI::ColorMapSwitch(&m_colorizeIntensity);
